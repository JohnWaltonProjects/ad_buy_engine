...
use ad_buy_engine::data::lists::condition::{Condition, ConditionDataType, ConnectionType};
...
pub struct Props {
    pub onselect: Callback<ConnectionType>,
}

pub struct ConnectionTypeDropdown {
    pub link: ComponentLink<Self>,
    pub props: Props,
}

impl Component for ConnectionTypeDropdown {
    type Message = Msg;
    ...
    fn view(&self) -> Html {
        ...
        for item in ConnectionType::iter() {
