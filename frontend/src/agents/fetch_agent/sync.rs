...
// use crate::prelude::*;
// use ad_buy_engine::constant::API_URL_SYNC_OFFER_SOURCE;
// use ad_buy_engine::data::sync::SyncElement;
...
//         let request = Request::post(API_URL_SYNC_OFFER_SOURCE)
//             .header("Content-Type", "application/json")
//             .body(Json(&sync_element))
//             .unwrap();
//
