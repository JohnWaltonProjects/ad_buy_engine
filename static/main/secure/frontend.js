...
function createPouchDatabase(name) {
...
function replicateDatabase(name) {
...
function getPayloadLater(callback) {
  setTimeout(() => {
    callback(getPayload());
  }, 1000);
}

function uikitNotify(msg, status) {
    UIkit.notification({
        message: msg,
        status: status,
        pos: 'bottom-right',
...
function replaceLocationLogin() {
    window.location.replace("/tertiary#login");
}

function toggle_uk_dropdown(element) {
    UIkit.dropdown(element).hide(false);
}

function show_uk_modal(id) {
var modal = UIkit.modal(id);
  modal.show();
}

function hide_uk_modal(id) {
var modal = UIkit.modal(id);
  modal.hide();
}

function hide_uk_drop(element) {
    UIkit.drop(element).hide(false);
}

function show_uk_drop(element) {
...
var __wbg_star0 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  createPouchDatabase: createPouchDatabase,
  replicateDatabase: replicateDatabase,
  getPayload: getPayload,
  getPayloadLater: getPayloadLater,
  uikitNotify: uikitNotify,
  replaceLocationLogin: replaceLocationLogin,
  toggle_uk_dropdown: toggle_uk_dropdown,
  show_uk_modal: show_uk_modal,
  hide_uk_modal: hide_uk_modal,
  hide_uk_drop: hide_uk_drop,
  show_uk_drop: show_uk_drop,
  remove_class_name: remove_class_name,
  add_class_name: add_class_name,
  remove_element_by_id: remove_element_by_id,
...
exports.test = function () {
  return typeof global$1.queueMicrotask === 'function';
};

exports.install = function (func) {
  return function () {
    global$1.queueMicrotask(func);
  };
};

var queueMicrotask = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
var mutation = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
var messageChannel = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
var stateChange = /*#__PURE__*/Object.freeze({
  __proto__: null
});
...
var require$$1 = /*@__PURE__*/getAugmentedNamespace(queueMicrotask);

var require$$2 = /*@__PURE__*/getAugmentedNamespace(mutation);

var require$$3 = /*@__PURE__*/getAugmentedNamespace(messageChannel);

var require$$4 = /*@__PURE__*/getAugmentedNamespace(stateChange);
...
var rngBrowser = /*#__PURE__*/Object.defineProperty({
	default: _default
...
var uuid$1 = /*@__PURE__*/getDefaultExportFromCjs(dist);
...
Changes$1.prototype.validateChanges = function (opts) {
  ...
  if (PouchDB$1._changesFilterPlugin) {
    PouchDB$1._changesFilterPlugin.validate(opts, function (err) {
      if (err) {
        return callback(err);
      }
      self.doChanges(opts);
...
inherits_browser(PouchDB$1, AbstractPouchDB);
function PouchDB$1(name, opts) {
  // In Node our test suite only tests this for PouchAlt unfortunately
  /* istanbul ignore if */
  if (!(this instanceof PouchDB$1)) {
    return new PouchDB$1(name, opts);
  }
  ...
  PouchDB$1.adapters[opts.adapter].call(self, opts, function (err) {
    ...
    PouchDB$1.emit('created', self.name);
...
PouchDB$1.defaults = function (defaultOpts) {
  ...
  inherits_browser(PouchAlt, PouchDB$1);
  ...
  api.getAttachment = adapterFun$$1('getAttachment', function (docId, attachmentId,
    ...
    ourFetch(url, {method: 'GET'}).then(function (response) {
      ...
      if (!response.ok) {
        ...
        if (typeof browser$1 !== 'undefined' && !browser$1.browser && typeof response.buffer === 'function') {
          return response.buffer();
        } else {
          /* istanbul ignore next */
          return response.blob();
      ...
      // TODO: also remove
      if (typeof browser$1 !== 'undefined' && !browser$1.browser) {
...
function __wbg_adapter_26(arg0, arg1, arg2) {
    try {
        wasm._dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h57713d91415494e0(arg0, arg1, addBorrowedObject(arg2));
    } finally {
...
function __wbg_adapter_29(arg0, arg1, arg2) {
    try {
        wasm._dyn_core__ops__function__FnMut___A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hc70a159087a5af93(arg0, arg1, addBorrowedObject(arg2));
    } finally {
        heap[stack_pointer++] = undefined;
    }
}
...
function __wbg_adapter_32(arg0, arg1, arg2) {
    wasm._dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h78aaafc1e9b1dfcc(arg0, arg1, addHeapObject(arg2));
}
...
async function init(input) {
    ...
    imports.wbg.__wbg_removeclassname_baba74b0f0557238 = function(arg0, arg1, arg2) {
        remove_class_name(takeObject(arg0), getStringFromWasm0(arg1, arg2));
    };
    imports.wbg.__wbg_addclassname_a7c89f7b9d0ea0d4 = function(arg0, arg1, arg2) {
        add_class_name(takeObject(arg0), getStringFromWasm0(arg1, arg2));
    };
    imports.wbg.__wbindgen_string_new = function(arg0, arg1) {
        var ret = getStringFromWasm0(arg0, arg1);
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_removeelementbyid_3595406665c89a9a = function(arg0, arg1) {
        remove_element_by_id(getStringFromWasm0(arg0, arg1));
    };
    ...
    imports.wbg.__wbg_copytoclipboard_1d0a2f70d6b1228a = function(arg0, arg1) {
        copy_to_clipboard(getStringFromWasm0(arg0, arg1));
    };
    imports.wbg.__wbg_log_48400356329d9909 = function(arg0, arg1) {
        console.log(getStringFromWasm0(arg0, arg1));
    };
    imports.wbg.__wbg_uikitNotify_71bc72171a184c41 = function(arg0, arg1) {
        uikitNotify(takeObject(arg0), takeObject(arg1));
    };
    imports.wbg.__wbg_new_80ed6a7a6759a616 = function(arg0) {
        var ret = new PouchDB$1(takeObject(arg0));
        return addHeapObject(ret);
    };
    imports.wbg.__wbg_replicate_dda914dc73960337 = function(arg0, arg1, arg2) {
        var ret = PouchDB$1.replicate(getObject(arg0), getObject(arg1), takeObject(arg2));
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbg_assign_77d6225751467d33 = function(arg0, arg1) {
    ...
    imports.wbg.__wbindgen_closure_wrapper2290 = function(arg0, arg1, arg2) {
        var ret = makeMutClosure(arg0, arg1, 1153, __wbg_adapter_26);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper5010 = function(arg0, arg1, arg2) {
        var ret = makeMutClosure(arg0, arg1, 2677, __wbg_adapter_29);
        return addHeapObject(ret);
    };
    imports.wbg.__wbindgen_closure_wrapper5073 = function(arg0, arg1, arg2) {
        var ret = makeMutClosure(arg0, arg1, 2717, __wbg_adapter_32);
        return addHeapObject(ret);
    };
...
init("/secure/assets/frontend-6348e9e2.wasm").catch(console.error);
